...
if selected_xai == "XAI_분류":
    if st.button("XAI 분류 실행"):
        st.components.v1.html(
            """
            <iframe src="https://titanicexplainer.herokuapp.com/multiclass/" style="width:100%; height:600px;"></iframe>
            """,
            height=600,
        )
    ...
    if st.button("XAI 회귀 실행"):
        st.components.v1.html(
            """
            <iframe src="https://titanicexplainer.herokuapp.com/regression/" style="width:100%; height:600px;"></iframe>
            """,
            height=600,
        )
